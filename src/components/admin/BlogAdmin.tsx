...
const BlogAdmin = () => {
  ...
  const fetchPosts = async () => {
    ...
    try {
      const status =
        activeTab !== "all"
          ? (activeTab as "draft" | "published" | "scheduled" | "pending")
          : undefined;
      const fetchedPosts = await getBlogPosts({ status, search: searchTerm });
  ...
  const handleEditPost = (postId: string) => {
    // Use navigate with the correct path to edit the post
    navigate(`/admin/blog/edit/${postId}`);
  };

  const handleViewPost = (slug: string) => {
    // Use navigate with the correct path to view the post
    navigate(`/blog/${slug}`);
  };
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex gap-2">
            <Button
              ...
              className="gap-2"
            >
              <FileText className="h-4 w-4" /> Use Cases
            </Button>
            <Button
              variant="outline"
                        ...
                        <AlertDialogContent>
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                              ...
                              permanently delete the post "{post.title}" and
